...
#include "InteractorStylePolygonDraw2.h"
#include "ImageViewer.h"

using namespace std;
vtkStandardNewMacro(InteractorStylePolygonDraw2);

InteractorStylePolygonDraw2::InteractorStylePolygonDraw2()
	:AbstractNavigation()
{
	this->m_interpolator = 
...
void InteractorStylePolygonDraw2::OnLeftButtonDown()
{
	AbstractNavigation::OnLeftButtonDown();
}

void InteractorStylePolygonDraw2::OnRightButtonDown()
{
...
void InteractorStylePolygonDraw2::OnMouseMove()
{
...
void InteractorStylePolygonDraw2::OnKeyPress()
{
...
void InteractorStylePolygonDraw2::SetCustomEnabled(bool b)
{
...
void InteractorStylePolygonDraw2::NewContour()
{
...
void InteractorStylePolygonDraw2::SetContourLabel(unsigned char noSegLabel)
{
	this->m_contourLabel = noSegLabel;
}

void InteractorStylePolygonDraw2::CleanCurrentContour()
{
	if (m_contours.size() > 0) {
...
void InteractorStylePolygonDraw2::CleanAllContours()
{
...
void InteractorStylePolygonDraw2::SetAllContoursEnabled(int flag)
{
	for (list<vtkSmartPointer<vtkContourWidget>>::const_iterator cit
		= m_contours.cbegin(); cit != m_contours.cend();
		++cit) {
...
void InteractorStylePolygonDraw2::SetSmoothCurveEnable()
{
	SetLineInterpolator(0);
}

void InteractorStylePolygonDraw2::SetPolygonEnable()
{
	SetLineInterpolator(1);
}

void InteractorStylePolygonDraw2::SetLineInterpolator(int i)
{
	switch (i)
	{
	case 0:
...
void InteractorStylePolygonDraw2::FillPolygon()
{
...
void InteractorStylePolygonDraw2::FillPolygon(
	...
	SAFE_DOWN_CAST_IMAGE_CONSTITERATOR(InteractorStylePolygonDraw2, GetImageViewer()->Render());
