...
Copyright (C) 2016
*/
#ifndef __INTERACTOR_STYLE_POLYGON_DRAW2_H__
#define __INTERACTOR_STYLE_POLYGON_DRAW2_H__
...
class InteractorStylePolygonDraw2 : public AbstractNavigation
{
public:

	vtkTypeMacro(InteractorStylePolygonDraw2, AbstractNavigation);
	static InteractorStylePolygonDraw2* New();
...
#endif // !__INTERACTOR_STYLE_POLYGON_DRAW2_H__
