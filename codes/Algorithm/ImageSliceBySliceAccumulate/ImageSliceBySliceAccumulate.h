...
Module:    ImageSliceBySliceAccumulate.h
...
=========================================================================*/
// .NAME ImageSliceBySliceAccumulate - Generalized histograms up to 3 dimensions.
// .SECTION Description
// ImageSliceBySliceAccumulate - This filter divides component space into
...
#ifndef __IMAGE_SLICE_BY_SLICE_ACCUMULATE_H__
#define __IMAGE_SLICE_BY_SLICE_ACCUMULATE_H__


#include "vtkImagingStatisticsModule.h" // For export macro
#include "vtkImageAlgorithm.h"
#include "imageslicebysliceaccumulate_export.h"

class vtkImageStencilData;

class IMAGESLICEBYSLICEACCUMULATE_EXPORT ImageSliceBySliceAccumulate : public vtkImageAlgorithm
{
public:
	static ImageSliceBySliceAccumulate *New();
	vtkTypeMacro(ImageSliceBySliceAccumulate, vtkImageAlgorithm);
...
private:
	ImageSliceBySliceAccumulate(const ImageSliceBySliceAccumulate&);  // Not implemented.
	void operator=(const ImageSliceBySliceAccumulate&);  // Not implemented.
};

#endif // !__IMAGE_SLICE_BY_SLICE_ACCUMULATE_H__
